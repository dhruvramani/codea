...
def get_config(def_model='p_codebert', def_plang='python', checkpoint=None,\
    ...
    parser.add_argument('--model', type=str.lower, default=def_model, choices=['p_codebert', ])
    ...
    parser.add_argument('--tokenizer_path', type=str, default=os.path.join(DATA_DIR, 'cache/')) # NOTE - IMP - change tokenizer_path when using non-codebert models.
    parser.add_argument('--models_save_path', type=str, default=os.path.join(save_dir, 'code_search_models/'))
    parser.add_argument('--tensorboard_path', type=str, default=os.path.join(save_dir, 'code_search_tensorboard/'))
